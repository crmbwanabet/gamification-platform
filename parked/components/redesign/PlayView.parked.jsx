// v2 Predictions + Daily (trivia) sub-tab components, extracted from components/redesign/PlayView.jsx
// on 2026-07-15 (features parked). To restore: move these back into PlayView.jsx, re-add the
// imports (DailyTriviaChallenge, predictionWinCoins, Check), the SUBS entries, the render branches,
// and the predictions/onPredict/user/onDailyAnswer props threaded from GamificationPlatform.
'use client';
