// The ENTIRE old (pre-v2) app shell render, extracted from components/GamificationPlatform.jsx
// on 2026-07-15. It was unreachable dead code in v2 (nav only exposes home/play/earn/store;
// profile is a modal). Contains the old trivia / quests / predictions tabs AND the old
// me.* screens (profile / VIP / referrals / leaderboard). Reference only — not standalone.
  return (
