...
export const TUTORIALS = {
  ...
  scratch: {
    ...
    tips: ['5 FREE scratch cards daily — plays refresh at 6am', 'Cards shuffle randomly every play', '2 out of 3 cards are winners'],
  },
  dice: {
    title: '🎲 Lucky Dice',
  ...
  tapfrenzy: {
    ...
    prizes: ['60+ points: 300 Coins 🏆', '45+ points: 200 Coins', '30+ points: 100 Coins'],
  ...
  stopclock: {
    ...
    prizes: ['Perfect game: 1000 Coins! 🏆', 'LIGHTNING exact: 400 Coins', 'All 3 within ±5: +200 bonus'],
