...
export const MINIGAMES = [
  { id: 'wheel', name: 'Wheel of Fortune', desc: 'Spin to win amazing prizes!', free: 3, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'wheel' },
  { id: 'scratch', name: 'Scratch & Win', desc: 'Scratch to reveal prizes!', free: 5, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'scratchCard' },
  { id: 'dice', name: 'Lucky Dice', desc: 'Roll the dice for rewards!', free: 5, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'dice' },
  { id: 'highlow', name: 'Higher or Lower', desc: 'Guess the next card!', free: 5, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'playingCards' },
  { id: 'plinko', name: 'Plinko Drop', desc: 'Drop the ball for big prizes!', free: 5, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'plinko', isNew: true },
  { id: 'tapfrenzy', name: 'Tap Frenzy', desc: 'Tap targets in 15 seconds!', free: 5, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'target', isNew: true },
  { id: 'stopclock', name: 'Stop the Clock', desc: 'Nail the target across 3 speeds!', free: 5, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'brainQuiz', isNew: true },
];
