...
// Daily missions pool (8 random picked each day: 2 easy, 3 medium, 3 hard)
export const DAILY_MISSION_POOL = [
  ...
  { id: 'd_highlow3', name: 'Streak Climber', desc: 'Hit a 3-card streak in Higher or Lower', difficulty: 'medium', target: 3, type: 'gamePlay', gameId: 'highlow', reward: { kwacha: 175 }, xp: 50, image: 'playingCards', cta: 'minigames', ctaLabel: 'Play Now' },
  { id: 'd_plinkoEdge', name: 'Edge Hunter', desc: 'Land an edge slot in Plinko', difficulty: 'medium', target: 1, type: 'gamePlay', gameId: 'plinko', reward: { kwacha: 200 }, xp: 60, image: 'plinko', cta: 'minigames', ctaLabel: 'Play Now' },
  // Hard (6)
  ...
  { id: 'd_jackpot', name: 'Jackpot Hunter', desc: 'Chase the perfect 200 on Stop the Clock', difficulty: 'hard', target: 1, type: 'gamePlay', gameId: 'stopclock', reward: { kwacha: 500, gems: 5 }, xp: 100, image: 'crown', cta: 'minigames', ctaLabel: 'Play Now' },
  ...
  { id: 'd_scratch3', name: 'Scratch Spree', desc: 'Play 3 scratch cards', difficulty: 'easy', target: 3, type: 'gamePlay', gameId: 'scratch', reward: { kwacha: 50 }, xp: 25, image: 'scratchCard', cta: 'minigames', ctaLabel: 'Play Now' },
  { id: 'd_dice3', name: 'Dice Roller', desc: 'Win 3 Lucky Dice rounds', difficulty: 'medium', target: 3, type: 'gamePlay', gameId: 'dice', reward: { kwacha: 175 }, xp: 50, image: 'dice', cta: 'minigames', ctaLabel: 'Play Now' },
  ...
  { id: 'd_wheel5', name: 'Wheel Veteran', desc: 'Spin the wheel 5 times', difficulty: 'hard', target: 5, type: 'gamePlay', gameId: 'wheel', reward: { kwacha: 400, gems: 5 }, xp: 100, image: 'wheel', cta: 'minigames', ctaLabel: 'Play Now' },
];
...
export const PERMANENT_MISSIONS = [
  ...
  { id: 'spinWheel', name: 'Lucky Spinner', desc: 'Spin the wheel 3 times', difficulty: 'easy', target: 3, type: 'wheelSpins', gameId: 'wheel', reward: { kwacha: 50 }, xp: 30, image: 'wheel', cta: 'minigames', ctaLabel: 'Play Now', tips: ['You get 3 free spins daily', 'Extra spins cost 50 Coins'] },
];
