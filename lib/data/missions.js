...
export const DAILY_MISSION_POOL = [
  ...
  { id: 'd_highlow3', name: 'Streak Climber', desc: 'Play Higher or Lower 10 times', difficulty: 'medium', target: 10, type: 'gamePlay', gameId: 'highlow', reward: { kwacha: 175 }, xp: 50, image: 'playingCards', cta: 'minigames', ctaLabel: 'Play Now' },
  ...
  { id: 'd_jackpot', name: 'Jackpot Hunter', desc: 'Play 20 rounds of Stop the Clock', difficulty: 'hard', target: 20, type: 'gamePlay', gameId: 'stopclock', reward: { kwacha: 500, gems: 5 }, xp: 100, image: 'crown', cta: 'minigames', ctaLabel: 'Play Now' },
  ...
  { id: 'd_dice3', name: 'Dice Roller', desc: 'Win 5 Lucky Dice rounds', difficulty: 'medium', target: 5, type: 'gamePlay', gameId: 'dice', reward: { kwacha: 175 }, xp: 50, image: 'dice', cta: 'minigames', ctaLabel: 'Play Now' },
  ...
  { id: 'd_wheel5', name: 'Wheel Veteran', desc: 'Spin the wheel 20 times', difficulty: 'hard', target: 20, type: 'gamePlay', gameId: 'wheel', reward: { kwacha: 400, gems: 5 }, xp: 100, image: 'wheel', cta: 'minigames', ctaLabel: 'Play Now' },
];
