...
import { GAME_ECONOMY } from './platform';
...
export const TRIVIA_GAMES = [
  { id: 'classicQuiz',  name: 'Classic Quiz',   desc: '10 questions, pick a category', icon: '🧠', color: 'from-purple-500 to-fuchsia-600', free: 3, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'brainQuiz' },
  { id: 'speedRound',   name: 'Speed Round',    desc: '20 True/False in 60 seconds',   icon: '⚡', color: 'from-amber-500 to-orange-600',   free: 5, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'speedRound',   isNew: true },
  { id: 'streakTrivia', name: 'Streak Trivia',  desc: 'Answer or cash out!',            icon: '🏆', color: 'from-rose-500 to-pink-600',      free: 3, cost: GAME_ECONOMY.EXTRA_PLAY_COST, image: 'streakTrivia' },
];
